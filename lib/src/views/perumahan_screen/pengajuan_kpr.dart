...
class PengajuanKPR extends StatefulWidget {
  @override
  _PengajuanKPRState createState() => _PengajuanKPRState();
}

class _PengajuanKPRState extends State<PengajuanKPR> {
  GlobalKey<ScaffoldState> _scaffoldKey;

  double _dLamaAngsuran = 5;
  int _lamaAngsuran = 5;
  ...
  PengajuanKPR get widget => super.widget;
    ...
    _dbBarang.getList().then((_) {
      switch (_) {
        case HttpStatus.success:
          _listBarang = _dbBarang.listBarang.where((f) => f.kategori == 'perumahan').toList();
...
//    _persenBunga = (2 / _dLamaAngsuran);
  ...
  String hitungPokok() {
    setState(() {
      _pokok = ((_nominalPengajuan / (_lamaAngsuran * 12)).round() / 100).ceil() * 100;
...
//      }
      ...
      _bunga =
          ((_nominalPengajuan * ((1.16666666667) / 100)).round() / 100).ceil() *
              100;
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: DropdownButton<String>(
                            isExpanded: true,
                            value: _barang,
                            hint: Text("Silahkan pilih Perumahan"),
                            ...
                            children: <Widget>[
                              Slider(
                                ...
                                onChanged: (v) {
                                  print(v);
                                  setState(() {
                                    if (v == 8.333333333333332) {
                                      _dLamaAngsuran = 7;
                                      _lamaAngsuran = 7;
                                    } else if (v == 11.666666666666666) {
                                      _dLamaAngsuran = 10;
                                      _lamaAngsuran = 10;
                                    } else {
                                      _dLamaAngsuran = v;
                              ...
                              Center(
                                child: Text(_lamaAngsuran.toString() + ' Tahun',
