...
class AddPengajuanPerumahanView extends StatefulWidget {
  @override
  _AddPengajuanPerumahanViewState createState() => _AddPengajuanPerumahanViewState();
}

class _AddPengajuanPerumahanViewState extends State<AddPengajuanPerumahanView> {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text("Filter Perumahan", style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
                          ),),
                          Padding(
