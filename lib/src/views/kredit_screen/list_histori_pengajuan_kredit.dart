...
class HistoriPengajuanBarangListPage extends StatefulWidget {
  static String tag = 'pengajuan-list-page';

  HistoriPengajuanBarangListPage({Key key, this.title, this.user}) : super(key: key);

  final String title;
  final User user;

  @override
  _HistoriPengajuanBarangListPageState createState() => _HistoriPengajuanBarangListPageState();
}

class _HistoriPengajuanBarangListPageState extends State<HistoriPengajuanBarangListPage> {
  ...
  HistoriPengajuanBarangListPage get widget => super.widget;
  ...
  void getListData() async {
    ...
    setState(() {
      _listPengajuan.forEach((_) {
        if (_.statusPengajuan.toLowerCase() != 'proc' && _.statusPengajuan.toLowerCase() != 'can' && _.statusPengajuan.toLowerCase() != 'new' && _.statusPengajuan.toLowerCase() != 'app' && _.statusPengajuan.toLowerCase() != 'vrf' && _.tipePengajuan.toLowerCase() != 'uang') {
          _listData.add({
            'typeof': 'pengajuan',
