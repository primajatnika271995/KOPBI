...
class _PengajuanKreditPageState extends State<PengajuanKreditPage> {
  ...
  PengajuanKreditPage get widget => super.widget;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Ajukan Pinjaman Barang"),
      ),
      body: Center(
        child: ListView(
                              ...
                              Padding(
                                ...
                                child: _tipePengajuan == 'Barang'
                                    ? DropdownButton<String>(
                                        isExpanded: true,
                                        value: _barang,
                                        hint: Text("Silahkan pilih barang"),
