...
class UploadFotoVerifikasiPenarikan extends StatefulWidget {
  @override
  _UploadFotoVerifikasiPenarikanState createState() => _UploadFotoVerifikasiPenarikanState();
}

class _UploadFotoVerifikasiPenarikanState extends State<UploadFotoVerifikasiPenarikan> {
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text("*Silahkan upload foto surat keterangan berakhir kerja atau paklaring anda.", style: TextStyle(
              fontSize: 12,
