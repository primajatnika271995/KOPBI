...
class ListKendaraanBerjalanView extends StatefulWidget {
  @override
  _ListKendaraanBerjalanViewState createState() =>
      _ListKendaraanBerjalanViewState();
}

class _ListKendaraanBerjalanViewState extends State<ListKendaraanBerjalanView> {
