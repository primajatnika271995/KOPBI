...
//        '/storage/emulated/0/Android/data/id.or.kopbi.solusi.mobile/files/Pictures/$nomorAnggota.jpg');
    ...
    var newim2 = new File('/storage/emulated/0/Android/data/id.or.kopbi.solusi.mobile/files/Pictures/1.jpg')
  ...
  void postUpdate() async {
    if (photo == null) {
      ...
      toggleLoading();
      await service.verifikasiFoto(photo).then((response) async {
